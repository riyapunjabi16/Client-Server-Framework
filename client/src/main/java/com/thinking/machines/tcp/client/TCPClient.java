...
public TCPClient(int portNumberForSendingRequest,String ipAddressForSendingRequest,int
portNumberForReceivingRequest,String ipAddressForReceivingRequest,TCPListener tcpListener)
throws IOException
{
...
int uuidSize=isForSendingRequest.read(uuidBytes);
osForSendingRequest.write(ack);
osForSendingRequest.flush();
...
isForReceivingRequest.read(ack);
Client client=new Client();
client.setId(uuid);
incomingRequestProcessor=new
IncomingRequestProcessor(socketForReceivingRequest,TCPClient.this,tcpListener,client,isForReceivingRequest,osForReceivingRequest);
outgoingRequestProcessor=new
OutgoingRequestProcessor(socketForSendingRequest,TCPClient.this,client,isForSendingRequest,osForSendingRequest);
